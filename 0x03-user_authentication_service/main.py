...
def log_in_wrong_password(email: str, password: str) -> None:
    ...
    assert response.cookies.get("session_id") is None, "Session ID should not be set"
...
def profile_unlogged() -> None:
    ...
    assert response.status_code == 403, "Expected 403 for unauthorized profile access"
...
def log_out(session_id: str) -> None:
    ...
    assert response.json() == {"message": "Bienvenue"}, "Unexpected logout response"
